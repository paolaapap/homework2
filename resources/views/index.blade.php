 ...
 <html>
  <head>
    <meta charset="utf-8">
      ...
      <script src='{{ URL::to("index.js") }}' defer></script>
  ...
  <body>
    <header>
        <div id="header_nav_upper">
            ...
            <a class="a1" href='{{ URL::to("login") }}'>Membership</a>
        ...
        <div id="header_nav_lower">
            ...
            <a href="">Store</a>   
            <img src='{{ URL::to("images\search_icon.png") }}' />
            <div class="profile">
                @if(!isset($error))
                <h1>Hello, {{ $nome }}</h1>
                @if($genere == "Female")
    ...
    <section id="header_scroll" class="hidden">
        ...
        <div class="right">
            <span class="hotel">Nearby Hotel</span>
            <a href='{{ URL::to("login") }}'>Membership</a>
            <a href="">Tickets</a>
        </div>
    </section>
    ...
    <section id="pop_up_m_a" class='pop_up_menu hidden'>
        <a href='{{ URL::to("collection") }}'>The Collection</a>
        <span>Artists</span>
        <span>Art terms</span>
        <span>Audio</span>
        <span>Magazine</span>
    ...
    @if(isset($error))
    <section id='orange'>
        <a href='{{ URL::to("login") }}'><div class='orange_figlio'>
            <div class='o1'>
    ...
    <section id="store">
        <div class="store1">
            ...
            <img src='{{ URL::to("images\store1.jpg") }}'/>
            <div class="subtitle">Good Design in Living Color</div> 
        </div>
        <div class="store2">
            <div class="title">Store</div>
            <img src='{{ URL::to("images\store2.png") }}'/>
    ...
    <footer id="footer">
        <div class="footer_section">
            ...
            <a href='{{ URL::to("login") }}' class='word right'>Log in</a>
        </div>
        <div class="footer_address">
            <div class="left">
                ...
                <div class="social">
                    <img class="icon" src='{{URL::to("images/instagram.png") }}'/>
                    <img class='icon f' src='{{URL::to("images/facebook.png") }}'/>
                    <img class="icon" src='{{URL::to("images/mail.png") }}'/>
                    <img class="icon" src='{{URL::to("images/tiktok.png") }}'/>
                    <img class='icon s' src='{{URL::to("images/spotify.png") }}'/>
                    <img class="icon" src='{{URL::to("images/youtube.png") }}'/>
